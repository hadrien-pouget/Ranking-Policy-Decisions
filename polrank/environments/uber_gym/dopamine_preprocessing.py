...
"""
Modified with dual states to return both the processed state and real state.
"""
...
class AtariPreprocessing(object):
  ...
  def __init__(self, environment, dual_state, frame_skip=4, terminal_on_life_loss=False,
               screen_size=84):
  ...
  def reset(self):
    ...
    if self.dual_state:
      return self._pool_and_resize(), obs
  ...
  def step(self, action):
    ...
    return (observation, true_obs), accumulated_reward, is_terminal, info
